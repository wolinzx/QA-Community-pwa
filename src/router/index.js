...
export default new Router({
  routes: [
    ...
    },
    {
      ...
      children: [
        {path: '/',name: 'Home', redirect: '/Home/Follow', meta: {z_index: 1}},
        {path: '/Home/Follow',name: 'Follow', component: Follow, meta: {z_index: 1}},
        {path: '/Home/Recommend',name: 'Recommend', component: Recommend, meta: {z_index: 1}},
        {path: '/Home/Popular',name: 'Popular', component: Popular, meta: {z_index: 1}},
      ]
    },
    {
      path: '/Message',
    ...
    },
    {
      ...
      children: [
        { path: '/Mine/Login',name: 'Login', component: Login, meta: {isChild: true} },
        { 
          path: '/Mine/Profile',
          name: 'Profile', 
          component: Profile, 
